...
interface ShowcaseExampleType {
  name: string;
  slug: string;
}
interface ShowcaseExampleSectionType {
  title: string;
  data: ShowcaseExampleType[];
}
interface ShowcaseExampleScreenSectionType
  extends ShowcaseExampleSectionType {
  data: ShowcaseExampleScreenType[];
}
export const screens: Array<ShowcaseExampleScreenSectionType> = [
  {
    title: 'Basic',
    data: [
      {
