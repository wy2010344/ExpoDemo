    ...
    <SafeAreaView style={styles.screen}>
      <View style={styles.bottomContainer}>
        ...
        <AnimatedTouchableOpacity
          ...
          <Image
            source={require('./messenger/caret-right.png')}
            style={styles.icon}
          />
        </AnimatedTouchableOpacity>

        <Animated.Image
          source={require('./messenger/action.png')}
          style={[styles.icon, featureIconAnimation]}
        />
        <Animated.Image
          source={require('./messenger/camera.png')}
          style={[styles.icon, featureIconAnimation]}
        />
        <Animated.Image
          source={require('./messenger/gallery.png')}
          style={[styles.icon, featureIconAnimation]}
        />
        <Animated.Image
          source={require('./messenger/voice.png')}
          style={[styles.icon, featureIconAnimation]}
        />
        ...
        <TouchableOpacity style={styles.submitButton}>
          {!message ? (
            <Image
              source={require('./messenger/like.png')}
              style={styles.icon}
            />
          ) : (
            <Image
              source={require('./messenger/send.png')}
              style={styles.icon}
            />
          )}
        </TouchableOpacity>
