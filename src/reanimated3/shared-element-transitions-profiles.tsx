...
/**
 * 这是官方的demo https://docs.swmansion.com/react-native-reanimated/docs/shared-element-transitions/overview/
 * @returns 
 */
export default function sharedElementTransitionsProfiles() {
  return (
